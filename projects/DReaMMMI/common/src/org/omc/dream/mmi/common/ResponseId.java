...
/*
 * $(@)ResponseId.java $Revision: 1.1.1.1 $ $Date: 2006/07/16 21:24:07 $
 * 
 ...
 * 
 * 
 * @poseidon-object-id [Im7bf8e319m10ad492ce3amm65e1]
 */
public class ResponseId {
    ...
    public ResponseId(String strResponseId) {
 ...
 */
    public String print(String delimiter) {
        return new String(delimiter+"ResponseId="+strResponseId);
    }
}
